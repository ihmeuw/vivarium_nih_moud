...
if __name__ == "__main__":
    ...
    about = {}
    with open(os.path.join(src_dir, "vivarium_nih_moud", "__about__.py")) as f:
        exec(f.read(), about)
    ...
    setup(
        ...
        zip_safe=False,
        use_scm_version={
            "write_to": "src/vivarium_nih_moud/_version.py",
        ...
        entry_points="""
            [console_scripts]
            make_artifacts=vivarium_nih_moud.tools.cli:make_artifacts
            make_results=vivarium_nih_moud.tools.cli:make_results
        """,
    )
